...
public class SearchUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("RURAL BANK - MAILAGASTHENNE");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/Cooperative Rural Bank.jpg"))); // NOI18N
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        try {
            ...
            ResultSet rs= con.createStatement().executeQuery("SELECT * FROM memberaccountdetail WHERE accountNo ='"+jTextField1+"'");
        } catch (Exception e) {
        } 
